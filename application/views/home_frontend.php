<div class="page-content">
  ...
  <section class="py-4">
    <div class="container">
      <div class="d-flex align-items-center">
        <h5 class="text-uppercase mb-0">TERBARU</h5>
        <a href="javascript:;" class="btn btn-dark btn-ecomm ms-auto rounded-0">Lihat Lainnya<i class='bx bx-chevron-right'></i></a>
      </div>
      <hr />
                      ...
                      <div class="product-action mt-2">
                        <div class="d-grid gap-2">
                          <?php if ($this->session->userdata('pelangganid') != "") : ?>
                            <button type="submit" class="btn btn-danger btn-ecomm"> <i class="bx bxs-cart-add"></i> Masukkan Keranjang</button>
                          ...
                          <!-- <?php echo "<a class='btn btn-dark btn-ecomm' href='" . site_url('Utamas/detail/' . $val['id']) . "'>" . 'Detail' . "</a>" ?> -->
                        </div>
                      </div>
                    </div>
                  </div>
  ...
  <section class="py-4">
    <div class="container">
      <div class="d-flex align-items-center">
        <h5 class="text-uppercase mb-0">Kategori</h5>
        ...
        <div class="browse-category owl-carousel owl-theme">
          <?php if ($kategori && count($kategori) > 0) :
            foreach ($kategori as $key => $val) : ?>
              <a href="<?= site_url('kategori_produks/index/' . $val['id']); ?>" class="item">
                <div class="item">
                  <div class="card rounded-0 product-card border">
                    <div class="card-body">
                      <!-- <img src="<?= config_item('base_url') ?>template_frontend/assets/images/categories/01.png" class="img-fluid" alt="..."> -->
                    </div>
                    <div class="card-footer text-center">
                      <h6 class="mb-1 text-uppercase"><?= $val['nama']; ?></h6>
                      <p class="mb-0 font-12 text-uppercase">Total Produk ()</p>
                    </div>
                  </div>
                </div>
              </a>
