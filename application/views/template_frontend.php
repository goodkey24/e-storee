            ...
            <div class="row align-items-center">
              <div class="col-4 col-md-auto">
                <div class="d-flex align-items-center">
                  ...
                  <div class="logo d-none d-lg-flex">
                    <a href="index.html">
                      <img src="<?= config_item('base_url') ?>asset\e_store_logo\logo1.jpg" class="logo-icon" alt="" />
                    </a>
                  </div>
                </div>
              </div>
              <div class="col col-md order-4 order-md-2">
                <div class="input-group flex-nowrap px-xl-4">
                  ...
                  <span class="input-group-text cursor-pointer bg-transparent"><i class="bx bx-search"></i>
                  </span>
                </div>
              </div>
                  ...
                  <nav class="navbar navbar-expand">
                    ...
                    <ul class="navbar-nav ms-auto">
                      <li class="nav-item dropdown">
                        <a class="nav-link cart-link dropdown-toggle dropdown-toggle-nocaret" href="#" data-bs-toggle="dropdown"><i class="bx bx-user"></i></a>
                        <ul class="dropdown-menu">
                          <li>
                            <a class="dropdown-item" href="<?= site_url('profile_users') ?>">Akun Saya</a>
                          </li>
                          <li>
                            <a class="dropdown-item" href="<?= site_url('login_users/logout') ?>">Log Out</a>
                          </li>
                        </ul>
                      </li>
                      <li class="nav-item dropdown dropdown-large">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                          <a href="<?= site_url('checkouts') ?>">
                            <div class="cart-header">
                              <p class="cart-header-title mb-0">
                                <!-- Jumlah Barang Dalam Keranjang -->
                                <?php $query = $this->db->select('id')->from('checkout')->get();
                                echo $jmlbarang = $query->num_rows(); ?> ITEMS
                              </p>
                              <p class="cart-header-clear ms-auto mb-0">
                                VIEW CART
                              </p>
                            </div>
                          </a>
                          ...
                          <div class="d-grid p-3 border-top">
                            <a href="javascript:;" class="btn btn-dark btn-ecomm">CHECKOUT</a>
                          </div>
                        </div>
                      </li>
                    </ul>
                    ...
                    <ul class="navbar-nav ms-auto">
                      <li class="nav-item">
                        <a href="<?= site_url('login_users') ?>" class="nav-link btn btn-dark ">Sign in</a>
                      </li>
                      <li class="nav-item">
                        <a href="<?= site_url('registrations') ?>" class="nav-link btn btn-success">Sign Up</i></a>
                      </li>
                      <li class="nav-item dropdown dropdown-large">
                        <a href="#" class="nav-link dropdown-toggle dropdown-toggle-nocaret position-relative cart-link" data-bs-toggle="dropdown">
          ...
          <div class="container">
            <nav id="navbar_main" class="mobile-offcanvas navbar navbar-expand-lg">
              ...
              <ul class="navbar-nav">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="<?= site_url('abouts'); ?>">About Us </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="<?= site_url('contacts'); ?>">Contact Us </a>
                </li>
              </ul>
            </nav>
          </div>
